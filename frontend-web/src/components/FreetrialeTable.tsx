// ─────────────────────────────────────────────
// COMPOSANT – FreeTrialTable
// ─────────────────────────────────────────────

interface TrialRow {
  id: string;
  displayId: number;  // numéro séquentiel simple : 1, 2, 3...
  fullName: string;   // vient directement du backend
  email: string;
}
      ...
      <table className="w-full min-w-[500px]">
        ...
        <thead>
          <tr className="border-b border-gray-200">
            <th
              className="text-sm font-medium text-gray-500 text-left pb-3 pr-4 w-20"
            >
              ID
            </th>
            <th
            ...
            <th
              ...
              style={{ color: sortField === "email" ? "#f5a623" : "#6b7280" }}
            >
        ...
        <tbody>
          {trials.map((trial) => (
            ...
            >
              ...
              {/* fullName vient directement du backend */}
